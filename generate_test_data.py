...
def generate_test_data():
    ...
    def style_header(ws, headers):
        for col, header in enumerate(headers, 1):
            ...
            ws.column_dimensions[cell.column_letter].width = max(15, len(header) + 3)
    ...
    headers_3 = ["CCCD (*)", "Ngân hàng (*)", "Số tài khoản (*)", "Chủ tài khoản", "Ghi chú"]
    style_header(ws3, headers_3)
    
    # Sample row (will be skipped)
    add_sample_row(ws3, ["(CCCD mẫu)", "Vietcombank", "0123456789", "CHU TK", "Ghi chú mẫu"])
    
    sample_banking = [
        ["012345678901", "Vietcombank", "1234567890123", "NGUYEN VAN AN", "Lương"],
        ["012345678902", "BIDV", "31410001234567", "TRAN THI BINH", ""],
        ["012345678903", "Techcombank", "19032123456789", "LE HOANG CUONG", "TK công ty"],
        ["012345678903", "VietinBank", "104881234567", "LE HOANG CUONG", "TK cá nhân"],
        ...
        ["012345678909", "Sacombank", "060012345678", "NGO QUOC HUNG", "TK nhà hàng"],
        ["012345678910", "VPBank", "12345678901234", "LY THI KIM", "Nhận tiền YouTube"],
    ]
    ...
    headers_4 = ["CCCD (*)", "Loại xe (*)", "Biển kiểm soát (*)", "Tên xe", "Ghi chú"]
    style_header(ws4, headers_4)
    
    # Sample row (will be skipped)
    add_sample_row(ws4, ["(CCCD mẫu)", "Xe máy", "19A-12345", "Honda Vision", "Ghi chú mẫu"])
    ...
    sample_vehicles = [
        ...
        ["012345678903", "Ô tô tải", "19C-88888", "Hyundai Porter", "Xe vận chuyển"],
    ...
    # Sample row (will be skipped)
    add_sample_row(ws5, ["(CCCD mẫu)", "Hon_Nhan_NN", "Tên mẫu", "Việt Nam", "", "", "", "", ""])
