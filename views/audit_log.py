...
def page_audit_log():
    ...
    with tab_insert:
        df_insert = df_display[df_display['Hành động'] == 'INSERT'] if 'Hành động' in df_display.columns else pd.DataFrame()
    ...
    with tab_update:
        df_update = df_display[df_display['Hành động'] == 'UPDATE'] if 'Hành động' in df_display.columns else pd.DataFrame()
    ...
    with tab_delete:
        df_delete = df_display[df_display['Hành động'] == 'DELETE'] if 'Hành động' in df_display.columns else pd.DataFrame()
