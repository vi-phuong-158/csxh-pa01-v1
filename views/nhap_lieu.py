                ...
                for idx, row in df_nhan_than.iterrows():
                    ...
                    with col_info:
                        ...
                        **{row['loai_quan_he']}**: {row['ho_ten']} | 
                        ...
                        """)
                    with col_del:
                        with st.popover("🗑️", help=f"Xóa {row['ho_ten']}", key=f"pop_del_nt_{row['id']}"):
                            st.markdown("Bạn chắc chắn muốn xóa?")
        ...
        if current_cccd_qt and check_cccd_exists(current_cccd_qt):
            ...
            if qt_list:
                ...
                for item in qt_list:
                    ...
                    with col_del:
                            with st.popover("🗑️", key=f"pop_del_qt_{item['id']}"):
                                st.markdown("Bạn chắc chắn muốn xóa?")
        ...
        if current_cccd and check_cccd_exists(current_cccd):
            ...
            if not df_csxh.empty:
                ...
                for idx, row in df_csxh.iterrows():
                    ...
                    with col_del:
                        with st.popover("🗑️", help=f"Xóa {loai_hinh_text}", key=f"pop_del_csxh_{row['id']}"):
                            st.markdown("Bạn chắc chắn muốn xóa?")
        ...
        if current_cccd_tl and check_cccd_exists(current_cccd_tl):
            ...
            if not df_tai_lieu.empty:
                ...
                for idx, row in df_tai_lieu.iterrows():
                    ...
                    with col_del:
                        with st.popover("🗑️", help=f"Xóa {row['ten_file_goc']}", key=f"pop_del_tl_{row['id']}"):
                            st.markdown("Bạn chắc chắn muốn xóa?")
