                ...
                for idx, row in df_nhan_than.iterrows():
                    ...
                    with col_del:
                        with st.popover("🗑️", help=f"Xóa {row['ho_ten']}"):
                            ...
                            if st.button("Xác nhận", key=f"nl_del_nt_{row['id']}",
                                         type="primary"):
                                delete_nhan_than(row['id'])
                                st.toast(f"✅ Đã xóa {row['loai_quan_he']}: "
                                         f"{row['ho_ten']}")
                                st.rerun()
                st.markdown("---")
                ...
                for item in qt_list:
                    ...
                    with col_del:
                        with st.popover("🗑️", help="Xóa mục này"):
                            st.markdown("Xóa hoạt động này?")
                            if st.button("Xác nhận", key=f"del_qt_nl_{item['id']}",
                                         type="primary"):
                ...
                for idx, row in df_csxh.iterrows():
                    ...
                    with col_del:
                        with st.popover("🗑️", help=f"Xóa {loai_hinh_text}"):
                            ...
                            if st.button("Xác nhận", key=f"del_nl_csxh_{row['id']}",
                                         type="primary"):
                ...
                for idx, row in df_tai_lieu.iterrows():
                    ...
                    with col_del:
                        with st.popover("🗑️", help=f"Xóa {row['ten_file_goc']}"):
                            ...
                            if st.button("Xác nhận", key=f"del_tl_{row['id']}",
                                         type="primary"):
